...
if (isset($_POST['register'])) {
	...
	if (count($errors)==0) {
		...
		$pwd=md5($passd);
		$jam= "INSERT INTO mlays (id, usernemu, emeil, passwedi, level )VALUES(NULL,'$username','$email','$pwd','student')";
...
<?php 
$java= "SELECT * FROM  mlays WHERE id=(SELECT LAST_INSERT_ID())";
$sql=mysqli_query($conne, $java);
$qwe=mysqli_num_rows($sql);
if ($qwe > 0) {
