...
<body>
	<div style="background: silver;color: black; height: 100px;">
		...
		<div  style="float: right; margin-top: -30px;">
			...
			<button  style="padding: 10px; height: 50px; width: 90px;border-radius: 5px;"><a style="text-decoration: none;color: red;" href="login.php?logout='1'">LOGOUT</a></button>
		</div>
		<div>
			<?php if (isset($_SESSION['username'])):?>
		<h3 style="float: right; margin-right: 80px;"> WELCOME <b style="color: blue" > <?php echo $_SESSION['username'];?> </b> </h3>
	<?php endif ?>
		</div>
	</div>
	<?php 
